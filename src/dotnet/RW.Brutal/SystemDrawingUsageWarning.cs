...
/// <summary>
///     Marks any usage of "System.Drawing" when triggered by `SystemDrawingUsageAnalyzer` and displays a message in
///     the status bar and editor margin as a non-intrusive warning to use "Brutal.Maths" instead.
...
public class SystemDrawingUsageWarning(IReferenceExpression referenceExpression) : IHighlighting
{
